// -----------------------------------------------------------------------
// <copyright file="CaseberryDatabaseTraceListener.cs" company="IIS">
...
namespace IIS.Caseberry.Logging.MsEntLib
{
    ...
    public class CaseberryDatabaseTraceListener : FormattedTraceListenerBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaseberryDatabaseTraceListener"/> class.
        /// </summary>
        /// <param name="formatter">The formatter.</param>        
        public CaseberryDatabaseTraceListener(ILogFormatter formatter)
            : base(formatter)
        {
        }
        ...
        /// <summary>
        /// Declare the supported attributes for <see cref="CaseberryDatabaseTraceListener"/>
        /// </summary>
            ...
            var appLogEntry = new ApplicationLog
                                  {
                                      ...
                                      FormattedMessage = Formatter != null
        ...
        {
            EventHandler<DataObjectIdEventArgs> handler = NewLogEntryAdded;
